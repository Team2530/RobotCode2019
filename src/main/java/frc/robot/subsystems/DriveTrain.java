...
public class DriveTrain extends Subsystem {
  ...
  public void Drive(Joystick stick) {
    ...
    motor1.set(ControlMode.PercentOutput, stick.getY());
    motor3.set(ControlMode.PercentOutput, stick.getY());
  }
  ...
  public void XboxDrive(XboxController xbox) {
    ...
    motor1.set(ControlMode.PercentOutput, xbox.getY());
    motor3.set(ControlMode.PercentOutput, xbox.getY());
  }
